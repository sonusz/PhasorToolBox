...
class CommonHeader(KaitaiStruct):
    ...
    class Fracsec(KaitaiStruct):
        ...
        class LeapSecondOccurredEnum(Enum):
            no_leap_second_occurred_in_the_last_24hs = 0
            leap_second_occurred_in_the_last_24hs = 1

        class LeapSecondPendingEnum(Enum):
            no_leap_second_occurs_in_the_next_60s = 0
            leap_second_occurs_in_60s = 1
        ...
        def __init__(self, _io, _parent=None, _root=None):
            ...
            self.leap_second_occurred = self._root.Fracsec.LeapSecondOccurredEnum(self._io.read_bits_int(1))
            self.leap_second_pending = self._root.Fracsec.LeapSecondPendingEnum(self._io.read_bits_int(1))
